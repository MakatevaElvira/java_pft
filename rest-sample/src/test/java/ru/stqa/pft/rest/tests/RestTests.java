...
public class RestTests extends TestBase {
  ...
  private Set<Issue> getIssuesById1(int issueId) throws IOException {
  ...
  private int createIssue(Issue newIssue) throws IOException { //Идентификатор созданного баг-репорта
